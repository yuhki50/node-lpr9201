package com.yuhki50.lpr9201.sender.option;

public enum ProfileParameterType {
    /**
     * PAN ID
     * 0x0001 ~ 0x3FFF
     */
     ...
     * パラメータNo
     */
    protected int paramNo;

    /**
     * データ長のバイト数
     */
    protected int dataLengthByteSize;

    /**
     * @param paramNo            パラメータNo
     * @param dataLengthByteSize データ長のバイト数
     */
    ProfileParameterType(int paramNo, int dataLengthByteSize) {
     ...
     */
    public static ProfileParameterType getEnumByParamNo(int paramNo) {
        ProfileParameterType[] enumArray = ProfileParameterType.values();
